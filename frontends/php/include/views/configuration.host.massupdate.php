...
$frmHost->addRow(array(
	new CVisibilityBox('visible[auth_enabled]', isset($visible['auth_enabled']), 'auth_enabled', S_ORIGINAL), S_AUTHENTICATION.SPACE.S_ENABLED),
    new CCheckBox('auth_enabled', $auth_enabled, null, 1)
);

$frmHost->addRow(array(
	new CVisibilityBox('visible[auth_password]', isset($visible['auth_password']), 'auth_password', S_ORIGINAL), S_PASSWORD),
	new CTextBox('auth_password', $auth_password)
);
